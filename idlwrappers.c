...
bolom_lower_fit_cells_5pt(argc,argv)
int argc;
void *argv[];
{
    float *inproj,*sigma,*fitproj,*fret;
    ...
    fitimage = argv[23];
    fret = argv[24];
    bolomfit_lower_cells_5pt(*shot,chans,*nchans,inproj,sigma,*zinner,*zouter,
				*minprivate,*mincore,*maxinner,*maxouter,*drwtd,*dzwtd,*drwtb,*dzwtb,
        efit,*rax,*zax,*rxpt1,*zxpt1,*rxpt2,*zxpt2,fitproj,fitimage,fret);
...
void *argv[];
{
    ...
    fret = argv[21];
		iters = argv[22];
    bolomfit_lower(*shot,chans,*nchans,inproj,sigma,r,
